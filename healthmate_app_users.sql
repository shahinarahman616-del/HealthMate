...
CREATE TABLE `users` (
  ...
  `account_status` enum('Active','Inactive') COLLATE utf8mb4_unicode_ci DEFAULT 'Active',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `storage_used` bigint unsigned NOT NULL DEFAULT '0',
  `storage_limit` bigint unsigned NOT NULL DEFAULT '1073741824',
  PRIMARY KEY (`user_id`),
...
-- Dump completed on 2025-11-16 23:12:03
